            ...
            <form action="" className="mb-14" method="POST" onSubmit={handleSubmit(onSubmit)}>
                <div className="mt-3">
                    ...
                    <input
                        ...
                        placeholder="VD: demo..."
                    />
                    <div className="text-sm text-red-500 mt-0.5">{errors.username?.message}</div>
                </div>
                ...
                <div className="mt-3">
                    ...
                    <input
                        ...
                        className="shadow-[inset_0_1px_2px_rgba(0,0,0,0.1)] hover:shadow-none focus:shadow-[0_0_5px_#ccc] w-full border px-2 h-10 text-sm outline-none"
                        placeholder="VD: Lê Văn Tuân..."
                    />
                    <div className="text-sm text-red-500 mt-0.5">{errors.fullName?.message}</div>
                </div>
                ...
                <div className="mt-3">
                    ...
                    />
                    <div className="text-sm text-red-500 mt-0.5">{errors.phone?.message}</div>
                </div>
                ...
                <div className="mt-3">
                    ...
                    />
                    <div className="text-sm text-red-500 mt-0.5">{errors.confirm?.message}</div>
                </div>
