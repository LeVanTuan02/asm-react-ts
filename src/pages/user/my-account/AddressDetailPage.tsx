const AddressDetailPage = () => {
    return (
        <>
            ...
            <form action="" className="mt-4" id="form__update-address">
                <div className="grid grid-cols-12 gap-3">
                    <div className="col-span-12 md:col-span-6">
                        <label htmlFor="form__update-address-fullname" className="mb-1 block font-semibold">Họ tên *</label>
                        <input type="text" id="form__update-address-fullname" defaultValue="Lê Văn Tuân" className="shadow-[inset_0_1px_2px_rgba(0,0,0,0.1)] hover:shadow-none focus:shadow-[0_0_5px_#ccc] w-full border px-2 h-10 text-sm outline-none" placeholder="Nhập họ tên" />
                        <div className="text-sm mt-0.5 text-red-500" />
                    </div>
                    <div className="col-span-12 md:col-span-6">
                        <label htmlFor="form__update-address-phone" className="mb-1 block font-semibold">Số điện thoại *</label>
                        <input type="text" id="form__update-address-phone" defaultValue="0347888888" className="shadow-[inset_0_1px_2px_rgba(0,0,0,0.1)] hover:shadow-none focus:shadow-[0_0_5px_#ccc] w-full border px-2 h-10 text-sm outline-none" placeholder="Nhập họ tên" />
                        <div className="text-sm mt-0.5 text-red-500" />
                    </div>
                    <div className="col-span-12 mb-3">
                        <label htmlFor="form__update-address-email" className="font-semibold mb-1 block">Email *</label>
                        <input type="text" id="form__update-address-email" defaultValue="tuanlv@gmail.com" className="shadow-[inset_0_1px_2px_rgba(0,0,0,0.1)] hover:shadow-none focus:shadow-[0_0_5px_#ccc] w-full border px-2 h-10 text-sm outline-none" placeholder="Nhập địa chỉ email" />
                        <div className="text-sm mt-0.5 text-red-500" />
                    </div>
