    ...
    return (
        <>
            ...
            <div className="p-6 mt-24 overflow-hidden">
                <form action="" className="flex rounded-md shadow-sm mb-5" method="POST" id="voucher__form-search">
                    <input type="text" name="company-website" id="voucher__form-search-key" className="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-none rounded-l-md sm:text-sm border-gray-300 px-4 py-2 border outline-none" placeholder="Nhập mã voucher" />
                                ...
                                <table className="min-w-full divide-y divide-gray-200" id="voucher__list-table">
                                    ...
                                    <tbody className="bg-white divide-y divide-gray-200" id="voucher__list">
                                        <tr>
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900"> BGMAIDINH10 </td>
                                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900"> 1212 </td>
                                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900"> -9999 VNĐ </td>
                                            <td className="px-6 py-4 whitespace-nowrap text-sm text-blue-500"> 22/2/2022 22:36:00 </td>
                                            <td className="px-6 py-4 whitespace-nowrap text-sm text-blue-500"> 28/2/2022 22:36:00 </td>
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <a href="/#/admin/voucher/${voucher.id}/edit" className="h-8 inline-flex items-center px-3 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Edit</a>
                                                <button data-id="${voucher.id}" className="voucher__list-btn-delete h-8 inline-flex items-center px-3 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 ml-3">Delete</button>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500"> 123 </td>
