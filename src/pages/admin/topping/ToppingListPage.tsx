                                ...
                                <table className="min-w-full divide-y divide-gray-200" id="cate__list-table">
                                    ...
                                    <tbody className="bg-white divide-y divide-gray-200">
                                        <tr className="item__list-item-${item.id}">
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900"> Trân châu trắng </td>
                                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900"> 8.000 VNĐ </td>
                                            <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <a href="/#/admin/topping/${item.id}/edit" className="h-8 inline-flex items-center px-3 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Edit</a>
                                                <button data-id="${item.id}" className="topping__list-btn-delete h-8 inline-flex items-center px-3 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 ml-3">Delete</button>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
