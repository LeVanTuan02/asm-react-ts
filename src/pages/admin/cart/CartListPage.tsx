                                ...
                                <table className="min-w-full divide-y divide-gray-200" id="cate__list-table">
                                    <thead className="bg-gray-50">
                                        <tr>
                                            ...
                                            <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"> Thời gian đặt </th>
                                    ...
                                    <tbody className="bg-white divide-y divide-gray-200" id="cart__list">
                                        <tr className="item__list-item-${item.id}">
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                                <div className="text-sm font-medium text-gray-900"> Nguyễn Trần Khôi </div>
                                                <div className="text-sm text-gray-500"> 0347896888 </div>
                                            </td>
                                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900"> 153.247 VND </td>
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap text-sm text-blue-500"> 22/2/2022 22:40:07 </td>
                                            <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                <a href="/#/admin/cart/${item.id}/detail" className="h-8 inline-flex items-center px-3 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Detail</a>
                                            </td>
                                        </tr>
                                        <tr className="item__list-item-${item.id}">
                                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500"> 123 </td>
