                        ...
                        <ul>
                            {wishList?.map((item: any, index) => (
                                <li className="flex px-2 py-3 items-center" key={index}>
                                    ...
                                    <div className="ml-2">
                                        <Link to={`/san-pham/${item.productId.slug}`} className="block uppercase font-semibold">{item.productId.name}</Link>
                                        <p className="text-sm font-medium">{formatCurrency(item.productId.price)}</p>
