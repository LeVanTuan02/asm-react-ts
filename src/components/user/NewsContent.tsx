...
type NewsContentProps = {
    ...
    url: string,
    parameter?: string,
    getNews: (start: number, limit: number, parameter?: string) => any
};

const NewsContent = ({ page, getNews, parameter, url }: NewsContentProps) => {
    const [emptyNews, setEmptyNews] = useState<boolean>(false);
