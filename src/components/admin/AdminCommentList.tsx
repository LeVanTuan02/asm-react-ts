...
const AdminCommentList = ({ onSetTotal, start, limit }: AdminCommentListProps) => {
    ...
    const handleRemoveCmt = async (id: string) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                remove(id)
                    ...
                    .then(() => setComments(prev => prev?.filter(item => item._id !== id)));
            }
        })
    }
                    ...
                    <tr key={index}>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            <div className="flex items-center">
                                ...
                                <div className="ml-4">
                                    <div className="text-sm font-medium text-gray-900">{item.userId.fullName}</div>
