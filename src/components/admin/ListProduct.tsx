                    ...
                    <tr key={index}>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                            <div className="flex items-center">
                                ...
                                <Link to={`/san-pham/${item.slug}`} className="text-sm font-medium text-gray-900 ml-4 hover:underline">{item.name}</Link>
                            </div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{item.categoryId.name}</td>
                        <td className="px-6 py-4 whitespace-nowrap">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{item.view}</td>
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{item.favorites}</td>
                        <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <Link to={`/admin/product/${item.slug}/edit`} className="h-8 inline-flex items-center px-3 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Edit</Link>
                            <button
